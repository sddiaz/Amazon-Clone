...
import { CheckIcon, Clock, MapPin } from "lucide-react";
...
import CategoryCarousel from "@/app/components/Shared/CategoryCarousel";
...
export default function Page(props: ProductPageProps) {
  ...
  return (
    <div className="flex flex-col justify-center items-center max-w-[1500px] mx-auto relative">
      {/* Product Section Container */}
      <div>
        {productInfo && mainImage && (
          <div className="p-10 h-full flex flex-col md:flex-row">
            {/* Images */}
            <div className="drop-shadow-md  max-w-[1000px] md:w-1/2 flex flex-col items-center h-full gap-4">
              {/* Main Image */}
              <div className="aspect-square relative w-3/4 border rounded-md drop-shadow-xs">
                <Image
                  loading="lazy"
              ...
              {/* Thumbnails Row */}
              <div className="flex gap-2 justify-center w-full overflow-none">
            ...
            <div className="w-full md:w-1/4 p-4">
              <div className="border-b border-[#00000044]">
                <div className="text-2xl font-ember">{productInfo?.title}</div>
                {/* Rating */}
                <AmazonRating rating={productInfo?.rating} />
                {orderInfo && (
              ...
              <div className="mt-2 pb-2 border-b border-[#00000044]">
                ...
                {productInfo?.price > 30 && (
                  <div className="text-sm font-emberThin">
                    <mark style={{ backgroundColor: "var(--amazonOrange)" }}>
                      Or{" "}
                      <span className="font-bold">
            ...
            <div className="w-full md:w-1/4 p-4 border rounded space-y-2">
              ...
              {productInfo?.stock > 0 ? (
                <div className="space-y-4">
                  <span className="text-xl font-ember text-green-600">
                    In Stock
                  </span>
      ...
      {/* Related Items */}
      <div className="w-[100vw] bg-gradient-to-b from-[#f3f3f3] via-transparent via-90% to-transparent">
        <h2 className="font-ember text-center pt-8 text-2xl pointer-events-none select-none mb-2">
          Related Picks For You
        </h2>
        <CategoryCarousel category={productInfo?.category as string} />
      </div>
      {/* Reviews */}
    </div>
  );
